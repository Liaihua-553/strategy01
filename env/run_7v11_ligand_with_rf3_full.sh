...
# MODIFIED 2026-04-05: record that this is the standard RF3-backed ligand full-run entrypoint.
# ORIGINAL:
# script standardized the ligand full invocation without an explicit history marker.
# MODIFIED:
# preserve the same behavior and parameters, while marking this file as the
# canonical RF3-backed full-run entrypoint used by remote SLURM launchers.
