...
# Purpose:
# - run the smallest standard ligand-binder smoke test when RF3 is available
# - uses the official ligand pipeline config unchanged
...
COMMON_ARGS=(
    "++run_name=7v11_ligand_with_rf3_smoke"
