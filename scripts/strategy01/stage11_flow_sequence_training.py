...
def grad_probe(model: torch.nn.Module, ae: torch.nn.Module, fm: Any, samples: list[dict[str, Any]], device: torch.device) -> dict[str, Any]:
    ...
    names = [
        ...
        "shared_seq_token_update.1.weight",
        "shared_seq_to_state_projector.weight",
        "latent_sequence_repair_projector.1.weight",
        "latent_sequence_repair_gate.1.weight",
        "state_xt_bb_ca_projector.1.weight",
        "state_xt_latent_projector.1.weight",
